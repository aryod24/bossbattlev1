...
<head>
    ...
    <title>CodeBossArena — Lupa Password</title>
            ...
            <div class="flex min-h-screen flex-col md:flex-row">
                ...
                <div class="auth-panel w-full md:w-2/5 flex items-center justify-center p-6 lg:p-8 min-h-screen">
                    <div class="w-full max-w-sm">
                        ...
                        <h3 class="font-headline text-3xl font-extrabold text-center mb-2" style="color: #e5e2e3;">Lupa Password</h3>
                        <p class="font-body text-center text-sm text-soft mb-8">Masukkan email Anda untuk menerima kode OTP reset password.</p>
                        ...
                        <form class="space-y-6" method="POST" action="{{ route('password.email') }}">
                            ...
                            <div class="pt-2">
                                <button class="btn-cyber-primary font-headline flex w-full items-center justify-center rounded-lg h-11 px-4 text-base font-bold tracking-wide" type="submit">
                                    <span class="truncate">Kirim Kode OTP</span>
                                </button>
                            </div>
                        </form>

                        <p class="font-body mt-8 text-center text-sm text-soft">
                            <a href="{{ route('login') }}" class="font-headline font-medium text-cyan-glow hover:underline">Kembali ke halaman Login</a>
                        </p>
                    </div>
                </div>
            </div>
