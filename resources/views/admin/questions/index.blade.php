<x-admin-layout>
    ...
    <div class="flex flex-wrap items-center justify-between gap-4 mb-6 bg-card p-6 rounded-2xl shadow-sm border border-border">
        ...
        <div class="flex flex-wrap gap-3">
            <a href="{{ route('admin.questions.template') }}" class="flex items-center justify-center gap-2 overflow-hidden rounded-lg h-11 px-5 bg-surface-dark border-2 border-border hover:border-text-primary hover:bg-surface-light text-text-primary text-sm font-bold transition-all shadow-sm">
            ...
            <a href="{{ route('admin.questions.banks.create') }}" class="flex items-center justify-center gap-2 overflow-hidden rounded-lg h-11 px-5 bg-surface-dark border-2 border-border hover:border-text-primary hover:bg-surface-light text-text-primary text-sm font-bold transition-all shadow-sm">
                <span class="material-symbols-outlined text-lg">library_add</span>
                <span class="truncate">Buat Bank Soal Baru</span>
            </a>
            <a href="{{ route('admin.questions.create', ['bank' => $currentBank]) }}" class="flex items-center justify-center gap-2 overflow-hidden rounded-lg h-11 px-5 bg-surface-dark border-2 border-text-primary text-text-primary hover:bg-text-primary hover:text-surface-dark text-sm font-bold transition-all shadow-sm">
