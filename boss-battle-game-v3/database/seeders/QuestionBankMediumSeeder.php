...
class QuestionBankMediumSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $questions = [
            [
                'level'         => 'Medium',
                'soal_text'     => 'Jika sebuah fungsi dideklarasikan sebagai: function sapa($nama = "Dunia"), apa string yang dikembalikan jika dipanggil tanpa argumen ( sapa() )?',
                'tipe'          => 'short_answer',
                'jawaban_benar' => 'Halo, Dunia!',
                'bobot_xp'      => 20,
            ],
            [
                'level'         => 'Medium',
            ...
            [
                'level'         => 'Medium',
                'soal_text'     => 'Apa deret angka yang dicetak oleh perulangan for dari $i = 1 hingga $i <= 3 dengan increment $i++?',
                'tipe'          => 'multiple_choice',
                'pilihan_a'     => '0 1 2',
                'pilihan_b'     => '1 2 3',
                'pilihan_c'     => '1 2 3 4',
            ...
            [
                'level'         => 'Medium',
                'soal_text'     => 'Jika fungsi tambah($a, $b) mengembalikan $a + $b, berapa hasil dari operasi aritmatika: tambah(3, 4) * 2?',
                'tipe'          => 'multiple_choice',
                'pilihan_a'     => '7',
                'pilihan_b'     => '14',
                'pilihan_c'     => '10',
