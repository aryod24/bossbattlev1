<x-dosen-layout>
    ...
    <div class="max-w-7xl mx-auto space-y-6">
        <div class="flex items-center gap-4 mb-8">
            <a href="{{ route('dosen.events.index') }}" class="p-2 hover:bg-card rounded-full transition-colors border border-transparent hover:border-border">
        ...
        <div class="bg-card rounded-2xl shadow-sm border border-border p-8">
            <form action="{{ route('dosen.events.update', $soloRaid) }}" method="POST">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="mb-6">
                            ...
                            <p class="text-sm text-text-muted mb-4">Edit materi pembelajaran dengan format Markdown.</p>
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    <label for="materi_node_1" class="block text-sm font-medium text-text-muted mb-2">📖 Materi Node 1 (Before Easy)</label>
                                    <textarea name="materi_node_1" id="materi_node_1">{{ $soloRaid->materi_node_1 }}</textarea>
                                </div>
                                <div>
                                    <label for="materi_node_2" class="block text-sm font-medium text-text-muted mb-2">📖 Materi Node 2 (Before Medium)</label>
                                    <textarea name="materi_node_2" id="materi_node_2">{{ $soloRaid->materi_node_2 }}</textarea>
                                </div>
                                <div>
                                    <label for="materi_node_3" class="block text-sm font-medium text-text-muted mb-2">📖 Materi Node 3 (Before Hard)</label>
                                    <textarea name="materi_node_3" id="materi_node_3">{{ $soloRaid->materi_node_3 }}</textarea>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        new EasyMDE({ element: document.getElementById('materi_node_1'), ...editorConfig });
        new EasyMDE({ element: document.getElementById('materi_node_2'), ...editorConfig });
        new EasyMDE({ element: document.getElementById('materi_node_3'), ...editorConfig });
    </script>
</x-dosen-layout>
