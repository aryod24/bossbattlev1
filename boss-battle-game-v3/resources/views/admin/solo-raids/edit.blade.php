                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <textarea name="info_node_1" id="info_node_1" rows="3" class="mt-1 block w-full rounded-md bg-background-dark border-border text-text-primary shadow-sm focus:border-primary focus:ring-primary">{{ $soloRaid->info_node_1 }}</textarea>
                                </div>
                                <div>
                                    <label for="info_node_2" class="block text-sm font-medium text-text-muted">Info Node 2 (Before Medium)</label>
                                    <textarea name="info_node_2" id="info_node_2" rows="3" class="mt-1 block w-full rounded-md bg-background-dark border-border text-text-primary shadow-sm focus:border-primary focus:ring-primary">{{ $soloRaid->info_node_2 }}</textarea>
                                </div>
                                <div>
                                    <label for="info_node_3" class="block text-sm font-medium text-text-muted">Info Node 3 (Before Hard)</label>
                                    <textarea name="info_node_3" id="info_node_3" rows="3" class="mt-1 block w-full rounded-md bg-background-dark border-border text-text-primary shadow-sm focus:border-primary focus:ring-primary">{{ $soloRaid->info_node_3 }}</textarea>
                                </div>
                            </div>
                        </div>
