<x-dosen-layout>
    ...
    <div class="max-w-7xl mx-auto space-y-6" x-data="raidEditForm()">
        <div class="flex items-center gap-4 mb-8">
            ...
            <div class="flex-1">
                <div class="flex items-center gap-3 mb-1">
                    ...
                    @endif
                    <span class="text-xs text-text-muted">Section: {{ $soloRaid->section }}</span>
                </div>
        ...
        <div class="bg-card rounded-2xl shadow-sm border border-border p-8">
            <form action="{{ route('dosen.events.update', $soloRaid) }}" method="POST" @submit="prepareSubmit()">
                @csrf
                @method('PATCH')
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div class="rounded-md bg-primary/5 border border-primary/20 px-3 py-2 text-xs text-text-muted">
                            <strong class="text-primary">Aturan slot section:</strong> setiap section hanya boleh berisi 1 event Materi dan 1 event Boss Battle. Mengubah Section/Tipe akan ditolak bila kombinasi tujuan sudah dipakai event lain.
                        </div>
