<x-app-layout>
    <div class="max-w-3xl mx-auto py-8 px-4">
        ...
        <div class="text-center mb-10">
            ...
            <h1 class="text-4xl font-black text-text-dark-primary mb-3">Pre-test Selesai!</h1>
            <p class="text-text-dark-secondary text-lg">Berikut adalah hasil penempatan Anda</p>
        </div>

        <!-- Score Card -->
        <div class="bg-surface-dark rounded-lg border border-border-dark p-8 mb-8 text-center">
            <div class="mb-6">
                <p class="text-text-dark-secondary text-sm uppercase tracking-wider mb-2">Skor Anda</p>
            ...
            <div class="grid grid-cols-2 gap-4 max-w-sm mx-auto mb-6">
                <div class="bg-background-dark rounded-lg p-4">
                    <p class="text-text-dark-secondary text-xs uppercase">Benar</p>
                    <p class="text-2xl font-bold text-green-400">{{ $pretestResult['jumlah_benar'] ?? $session->jumlah_benar }}</p>
                </div>
                <div class="bg-background-dark rounded-lg p-4">
                    <p class="text-text-dark-secondary text-xs uppercase">Total Soal</p>
                    <p class="text-2xl font-bold text-text-dark-primary">{{ $pretestResult['jumlah_soal'] ?? $session->jumlah_soal }}</p>
                </div>
            </div>
            ...
            <div class="border-t border-border-dark pt-6">
                <p class="text-text-dark-secondary text-sm mb-3">Anda ditempatkan di</p>
                <div class="inline-flex items-center gap-3 {{ $colors['bg'] }} {{ $colors['border'] }} border rounded-lg px-6 py-3">
                    ...
                    <div class="text-left">
                        ...
                        <p class="text-text-dark-secondary text-xs">
