<x-admin-layout>
    <div class="max-w-5xl mx-auto" x-data="bankForm()">
        ...
        <form method="POST" action="{{ route('admin.questions.banks.store') }}" class="space-y-6">
            @csrf
            ...
            <div class="flex justify-end gap-3">
                <a href="{{ route('admin.questions.index') }}" class="h-11 px-5 rounded-lg border border-border text-text-muted hover:bg-card flex items-center font-bold text-sm">Batal</a>
