...
class QuestionBankBossMediumSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $questions = [
            ...
            [
                'level'         => 'Medium',
                'soal_text'     => 'Keyword yang digunakan untuk melewati satu iterasi dalam perulangan tanpa menghentikan loop sepenuhnya adalah...',
                'tipe'          => 'multiple_choice',
                'pilihan_a'     => 'break',
                'pilihan_b'     => 'return',
                'pilihan_c'     => 'continue',
                'pilihan_d'     => 'skip',
                'jawaban_benar' => 'continue',
                'bobot_xp'      => 20,
            ],
            [
                'level'         => 'Medium',
            ...
            [
                'level'         => 'Medium',
                'soal_text'     => 'Fungsi PHP yang digunakan untuk membalik urutan elemen dalam sebuah array adalah...',
                'tipe'          => 'multiple_choice',
                'pilihan_a'     => 'array_flip()',
                'pilihan_b'     => 'array_reverse()',
                'pilihan_c'     => 'array_sort()',
                'pilihan_d'     => 'array_pop()',
                'jawaban_benar' => 'array_reverse()',
                'bobot_xp'      => 20,
            ],
            [
                'level'         => 'Medium',
            ...
            [
                'level'         => 'Medium',
                'soal_text'     => 'Fungsi PHP yang digunakan untuk mengubah seluruh karakter string menjadi huruf kecil adalah...',
                'tipe'          => 'multiple_choice',
                'pilihan_a'     => 'strtoupper()',
                'pilihan_b'     => 'ucfirst()',
                'pilihan_c'     => 'lcfirst()',
                'pilihan_d'     => 'strtolower()',
