...
class QuestionBankEasySeeder extends Seeder
{
    public function run(): void
    {
        ...
        $questions = [
            ...
            [
                'level'         => 'Easy',
                'soal_text'     => 'Dalam struktur percabangan, jika variabel bernilai 75, kondisi manakah yang akan terpenuhi terlebih dahulu: >= 80 atau >= 70?',
                'tipe'          => 'multiple_choice',
                'pilihan_a'     => '>= 80',
                'pilihan_b'     => '>= 70',
                'pilihan_c'     => 'Keduanya',
                'pilihan_d'     => 'Tidak ada yang terpenuhi',
                'jawaban_benar' => '>= 70',
                'bobot_xp'      => 10,
            ],
            [
            ...
            [
                'level'         => 'Easy',
                'soal_text'     => 'Dalam struktur match() di PHP 8, jika kita mencocokkan angka 2 pada pola "1 => \'Satu\', 2, 3 => \'Dua/Tiga\'", apa hasilnya?',
                'tipe'          => 'multiple_choice',
                'pilihan_a'     => 'Satu',
                'pilihan_b'     => 'Dua/Tiga',
                'pilihan_c'     => 'Lainnya',
                'pilihan_d'     => 'Error',
                'jawaban_benar' => 'Dua/Tiga',
                'bobot_xp'      => 10,
            ],
        ];
